export const wineList = [
  {
    ...
    descripton:
      "Very light oak influence allows the elevated, sun-soaked terroir of Mount Veeder to shine. Acidity is bright, and the wine has tart, juicy black fruits. Herbs and black licorice add nuance, while chewy tannins persist in a lingering finish, which is rich in stony mineral notes. If over-extracted Napa Cabs turned you away from the variety and region, this bottle promises to lure you back in. The 2014 vintage isdrinking exceptionally well, but it’s still a baby. This wine will mature with grace and elegance and can be left in the cellar for decades.",
  },

  {
    id: 2,
    name: "HERMANN J. WIEMER HJW VINEYARD RIESLING 2016",
    type: "White",
    price: "$40",
  ...
  {
    id: 7,
    name: "FLÂNEUR LA BELLE PROMENADE CHARDONNAY 2016",
    type: "White",
    price: "$50",
    image: "../assets/wines/wine-7.png",
    descripton:
  ...
  {
    id: 8,
    name: "CVNE ‘MONOPOLE CLASICO’ BLANCO 2015",
    type: "White",
    price: "$50",
    image: "../assets/wines/wine-8.png",
    descripton:
